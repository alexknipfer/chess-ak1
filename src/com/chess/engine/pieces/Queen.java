...
public class Queen extends Piece {
    ...
    /**
     * This method calculates the legal moves of any given queen
     *
     * @param board the current chess board
     * @return collection of legal moves for the queen
     */
    ...
    /**
     * This method checks to see if the current queen is in the first column.
     * If so, check to see if the offset is legal (i.e within the board bounds).
     *
     * @param currentPosition current position of queen
    ...
    /**
     * This method checks to see if the current queen is in the eighth column.
     * If so, check to see if the offset is legal (i.e within the board bounds).
     *
     * @param currentPosition current position of queen
     * @param candidateOffset the offset in which the piece is moving to
